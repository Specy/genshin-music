...
import {
    ...
    IMPORT_NOTE_POSITIONS, INSTRUMENTS, INSTRUMENTS_DATA, MIDI_BOUNDS,
    MIDI_MAP_TO_NOTE, MIDI_PRESETS, NOTE_MAP_TO_MIDI, NOTES_CSS_CLASSES,
    NOTE_NAME_TYPES, PITCHES, TEMPO_CHANGERS,
} from './imports'
import {expectGolden} from './golden'
