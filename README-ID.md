...
kemudian kloning repo ke sebuah folder dan instal dependensi dengan `npm i`, setelah terinstal, jalankan server developernya dengan skrip game tertentu (lihat di bawah)
