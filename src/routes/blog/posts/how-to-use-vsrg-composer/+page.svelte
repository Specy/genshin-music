...
<BaseBlogPost metadata={howUseVsrgComposerMetadata}>
  <p class="blog-p">
    This is a composer to create beatmaps for the songs you have in the app. You select a song you
  ...
  <BlogImage src="{base}/assets/blog/help-vsrg-composer-2.webp" alt="VSRG composer settings" />
  <ol class="blog-ol">
    <li>
      <b class="blog-b">Keys</b>: This is the number of tracks you want the beatmap to have, choose
      this wisely as changing it after you already made most of the beatmap might be difficult. A
      beatmap with less tracks might be easier to play, but harder to compose.
    </li>
    <li>
      <b class="blog-b"> BPM </b>: The bpm of the beatmap, it is used to give you guiding "columns"
    ...
    <li>
      <b class="blog-b">Base pitch</b>: This is the base pitch of the instruments of the beatmap,
    ...
    <li>
      ...
      oriented vertically or horizontally, it doesn't affect the beatmap.
    </li>
    <li>
      <b class="blog-b">Max FPS</b>: When you "play" the beatmap inside the editor, it moves at a
      certain FPS, high values might make the editor look smoother, but give a bit of inaccuracies
      in the audio, find a value that is best for your device, it doesn't affect the beatmap.
    </li>
    <li>
      <b class="blog-b">Snap scroll to snap point</b>: When this is enabled, once you release your
      mouse/finger from moving the canvas, it will "snap" to the closest snap point it can find.
    </li>
    <li>
      <b class="blog-b">Auto save changes</b>: Auto saves the changes to a song every 5 edits.
    </li>
    <li>
      <b class="blog-b">Background song</b>: Here you can select which of your songs will be used as
      a background for the beatmap, look further for more info about this section.
    </li>
  </ol>
  <p class="blog-p">
    When you select a song for a beatmap, you can decide which layers to include in the final song,
  ...
  <ol class="blog-ol">
    <li>
      ...
      will be played when that note is pressed.
    </li>
    <li>
      This is a held hit object, the person who will play the song will have to hold the button
      instead of just tapping it.
    </li>
    <li>
      This is the timeline, you will be shown the notes of the song you selected so that you can
      more easily place hit objects in your beatmap.
    </li>
    <li>
      This is the layer selection, a hit object is going to be part of a layer, each layer can have
      a different color and a different instrument. When you want to create a hit object of that
      layer, select the layer and then press on the canvas to create it.
    </li>
    <li>
      You can assign notes to a hit object, you need to select a hit object and then will be able to
      assign notes to it. Whenever the hit object will be pressed, the sound will be played.
    </li>
    <li>
      The action to execute whenever you tap, either create a new tap hit object, a held hit object,
      or delete the hit object that you click
    </li>
    <li>
      With this slider you can choose how much to "scale" the beatmap, to make it easier to view the
      whole beatmap
    </li>
    <li>
      Select the playback speed of the song, it's useful to listen more carefully to a song when
      composing
    </li>
    <li>
      Select how many snap points you want to create, 1/1 is one snap point per BPM, 1/2, ..., 1/16
      is to place more snap points between 1 BPM unit. Every unit's BPM snap point will have a
      different color than the inner BPM snap points.
    </li>
    <li>Current timestamp in the timeline.</li>
    <li>
      Add/Remove or move between the breakpoints of the beatmap, they are sections which you can
      more easily jump to
    </li>
  </ol>
