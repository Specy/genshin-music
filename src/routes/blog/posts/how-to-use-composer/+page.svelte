...
<BaseBlogPost metadata={composerTutorialMetadata}>
    ...
    <ol class="blog-ol">
        <li>Go to the next / previous breakpoint, a breakpoint can be added from the button in the timeline,
            it's
            a marker that you will be able to "jump" to</li>
        <li>This is a "timeline" where all breakpoints will be shown, the window inside of it shows you how the
            piece
        ...
        <li>Adds 16 columns at the end of the song, a column is the unit of time where you can place
            notes</li>
        <li>Remove the current selected column</li>
        <li>Adds a column after the current one</li>
        <li>Layer selection, here you can select your current layer, and create/remove other ones. Each layer
            can
        ...
        <li>Those are the "tempo changers", they are meant to change the tempo of a single column. The number
            (1/2, 1/4, etc...) tells
            ...
            increase (double) the BPM of your song</li>
    </ol>
    <Header>
        Composer Tools
    </Header>
    ...
    <ol class="blog-ol">
        ...
        <li>
            <b class="blog-b">Base pitch</b>: This is the default pitch of all instruments, you can override the pitch of a
            single
            instrument inside the settings of the instrument.
        </li>
        <li>
            <b class="blog-b">Beat marks</b>: This will cut the canvas into 3 or 4 "sections" of 4 columns, you can use
            those to help
            yourself
            with the tempo of the song.
        </li>
        <li>
            <b class="blog-b">Note name type</b>: The name that the notes in the keyboard of the composer will use.
        </li>
        <li>
            <b class="blog-b">Number of visible columns</b>: The number of columns that will be visible at a time in the
            canvas. Warning,
            a high
            value might cause lags, if you have lag issues, try to reduce this value.
        </li>
        <li>
            <b class="blog-b">Base reverb</b>: This will enable reverb by default for all instruments in the song, you
            can override
            this in the
            instrument.
        </li>
        <li>
            <b class="blog-b">Autosave changes</b>: It will auto save the changes you applied to a song every 5 edits.
        </li>
        <li>
            <b class="blog-b">Put next/previous column buttons around keyboard</b>: This adds two buttons on the left and
            right of the
            keyboard that
            selects the previous and next columns.
        </li>
        <li>
            <b class="blog-b">Autoplay in all tabs</b>: This is a feature that will start/stop playing all your browser
            tabs that have the
            composer open.
        </li>
        <li>
            <b class="blog-b">Lookahead time</b>: To prevent lags from the app affecting audio, notes are "scheduled" to be
            played a few
            milliseconds before
