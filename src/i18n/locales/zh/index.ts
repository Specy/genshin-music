...
export const i18n_zh = {
    ...
    settings: {
        ...
        props: {
            ...
            player_pitch: "曲调",
            player_pitch_description: "播放器的曲调，也将保存在您录制的歌曲中",
            player_bpm: "BPM",
            player_bpm_description: "每分钟节拍数，由节拍器使用，并在和编曲器转换歌曲时使用",
            player_sync_song_data: "自动同步歌曲的乐器和曲调",
            player_sync_song_data_description: "每当您加载歌曲时，该歌曲的乐器和曲调也会被加载",
    ...
    instruments: {
        ...
        "Panflute": "排笛",
        "Ocarina": "陶笛",
        "MantaOcarina": "魔鬼鱼陶笛",//A special bell shaped pottery flute in sky 
        ...
        "SFX_Dance": "音效雀跃",//the oringinal cry character is calied the child of light.
        "SFX_BirdCall": "音效鸟叫",// call is like "sound of a bird" or "sing"
        "SFX_CrabCall": "音效螃蟹",
        "SFX_FishCall": "音效鱼",
