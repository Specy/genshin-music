export const i18n_zh = {
    logs: {
        update_available: "发现新版本应用，是否进行更新？关闭/刷新软件的选项卡",
        error_with_the_app: "程序出现错误！",
        loading_instruments: "正在加载中，请稍候...",
        loading_song: "加载歌曲中...",
        could_not_find_song: "没有找到歌曲",
        error_loading_instrument: "乐器加载失败",
        error_opening_file: '未能打开文件',
        error_importing_song: '歌曲导入失败',
        error_downloading_audio: "音频下载失败，可能是歌曲太长了？",
