<script lang="ts">
    // Old: src/components/shared/SvgNotes/sky/dm.tsx (React). `style`/`color` props
...
<svg class="svg-note" version="0.0" viewBox="0 0 63.97 63.87" xmlns="http://www.w3.org/2000/svg">
    <path
