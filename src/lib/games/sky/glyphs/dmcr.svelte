<script lang="ts">
    // Old: src/components/shared/SvgNotes/sky/dmcr.tsx (React). `color` restored P4c Task 2
...
<svg class="svg-note" viewBox="0 0 63.87 63.87" xmlns="http://www.w3.org/2000/svg" style="fill:{color};stroke:{color}">
    <path
