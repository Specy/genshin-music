...
export const i18n_en = {
  logs: {
    update_available:
      'There is a new version of the app available, do you want to reload to update? Make sure you close/refresh other tabs of the app',
    ...
    converting_recorded_to_composed_warning:
      'Converting recorded song to composed, audio might not be accurate',
    suggest_backup:
      "You haven't backed up your songs in a while, remember to download the backup sometimes!",
  ...
  settings: {
    ...
    props: {
      ...
      composer_reverb_description:
        'Makes it sound like you are in a cave, this is the default value applied to every instrument',
      composer_autosave: 'Autosave changes',
      composer_autosave_description:
        'Autosaves the changes to a song every 5 edits and when you change page/song',
      ...
      player_loop_practice_description:
        'When you reach the end of the selected notes in the song in practice mode, it will loop back to the start',
      player_number_of_visual_columns_description:
        'The number of columns in the visual sheet, more columns might cause lag',
      player_number_of_visual_rows_description:
        'The number of rows in the visual sheet, more rows might cause lag',
      player_hide_practice_notes_description:
      ...
      player_approach_speed_description:
        'The time between when the notes appear and when they reach the end (in ms)',
      player_note_animation: 'Note animation',
      player_note_animation_description:
        'Toggle the animation of the notes (will reduce performance)',
      player_show_visual_sheet: 'Show visual sheet',
      player_show_visual_sheet_description:
        'Show the sheet above the keyboard (might reduce performance)',
      ...
      vsrg_composer_max_fps_description:
        'The FPS limiter of the editor, higher values could cause audio stutters',
      ...
      vsrg_composer_autosave_description:
        'Autosaves the changes to a song every 5 edits and when you change page/song',
      vsrg_composer_difficulty: 'Difficulty',
      vsrg_composer_difficulty_description:
        'Higher values means the notes need to be pressed more accurately',

      vsrg_player_approach_time: 'Approaching time',
      vsrg_player_approach_time_description:
        'The time between when the notes appear and when they reach the end (in ms)',
      vsrg_player_max_fps: 'Max FPS',
      vsrg_player_max_fps_description:
        'The FPS limiter of the player, too high values could cause stutters',
  ...
  theme: {
    ...
    opaque_performance_warning:
      'GIF backgrounds and opaque (transparent) colors could reduce performance',
  ...
  player: {
    ...
    song_search_description:
      'Here you can find songs to learn, they are provided by the sky-music library.',
    midi_or_audio_import_redirect_warning:
      'You cannot directly import this file format. MIDI, Video and Audio files need to be converted in the composer, do you want to open it?',
  ...
  keybinds: {
    ...
    midi_access_denied:
      'MIDI access was denied, please allow it in the browser settings and reload the page',
  ...
  backup: {
    ...
    confirm_after_folders_validation_error:
      'There were errors validating some folders. Do you want to continue downloading?',
    confirm_after_themes_validation_error:
      'There were errors validating some themes. Do you want to continue downloading?',
    confirm_delete_songs_step_1:
      "Write 'delete' if you want to delete all songs, press cancel to ignore", //do not translate 'delete'
    confirm_delete_songs_step_2: 'Are you REALLY sure you want to delete all songs?',
    confirm_delete_themes_step_1:
      "Write 'delete' if you want to delete all themes, press cancel to ignore", //do not translate 'delete'
