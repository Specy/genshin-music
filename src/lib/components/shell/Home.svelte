...
{#snippet vsrgComposerIcon()}
    <svg class="middle-size-page-icon" width="1em" height="1em" viewBox="0 0 192 177" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
{#snippet vsrgIcon()}
    <svg class="middle-size-page-icon" width="1em" height="1em" viewBox="0 0 222 211" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
{#snippet mdOutlinePianoIcon()}
    ...
    ><path fill="none" d="M0 0h24v24H0z"/><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 11.5h.25V19h-4.5v-4.5H10c.55 0 1-.45 1-1V5h2v8.5c0 .55.45 1 1 1zM5 5h2v8.5c0 .55.45 1 1 1h.25V19H5V5zm14 14h-3.25v-4.5H16c.55 0 1-.45 1-1V5h2v14z"/></svg>
{/snippet}
...
{#snippet bsMusicPlayerFillIcon()}
    <svg
        ...
        width="1em"
        xmlns="http://www.w3.org/2000/svg"
    ><path d="M8 12a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/><path d="M4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zm1 2h6a1 1 0 0 1 1 1v2.5a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1m3 12a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/></svg>
{/snippet}
...
>
    ...
    <div class="home-padded column">
        ...
        <div class="home-content">
            <AppLink
                ...
                onclick={homeStore.close}
            >
                <div class="home-content-background" style="background-image:url('{base}/manifestData/composer.webp')"></div>
                <div class="home-content-main" style="background-color:{cardBackground}">
                    <div class="home-content-title">
                        {@render faCompactDiscIcon()} {t('home:composer_name')}
                    </div>
            ...
            <AppLink
                ...
                onclick={homeStore.close}
            >
                <div class="home-content-background" style="background-image:url('{base}/manifestData/player.webp')"></div>
                <div class="home-content-main" style="background-color:{cardBackground}">
                    <div class="home-content-title">
                        {@render bsMusicPlayerFillIcon()} {t('home:player_name')}
                    </div>
                    <div class="home-content-text">
        ...
        <div class="row space-around middle-size-pages-wrapper">
            {@render middleSizePage('/vsrg-composer', currentPage === '/vsrg-composer', t('home:vsrg_composer_name'), vsrgComposerIcon)}
            {@render middleSizePage('/vsrg-player', currentPage === '/vsrg-player', t('home:vsrg_player_name'), vsrgIcon)}
            {@render middleSizePage('/zen-keyboard', currentPage === '/zen-keyboard', t('home:zen_keyboard_name'), mdOutlinePianoIcon)}
        </div>
        ...
        <div class="page-redirect-wrapper">
            ...
            {@render pageRedirect('sheetVisualizer', '/sheet-visualizer', currentPage === '/sheet-visualizer', t('home:sheet_visualizer_name'))}
            {@render pageRedirect('theme', '/theme', currentPage === '/theme', t('home:themes_name'))}
            {@render pageRedirect('blog', '/blog', currentPage.startsWith('/blog'), t('home:blog_and_guides_name'))}
            {@render pageRedirect('keybinds', '/keybinds', currentPage === '/keybinds', t('home:keybinds_or_midi_name'))}

            {@render pageRedirect('partners', '/partners', currentPage === '/partners', t('home:partners_name'))}

            {@render pageRedirect('backup', '/backup', currentPage === '/backup', t('home:backup_name'))}
            {@render pageRedirect('changelog', '/changelog', currentPage === '/changelog', t('home:changelog_name'))}
    ...
    <div class="home-bottom">
        ...
        <Row gap="0.5rem">
            ...
            >
                <input type="checkbox" checked={!homeStore.state.canShow} readonly id="hide-on-open-checkbox"/>
