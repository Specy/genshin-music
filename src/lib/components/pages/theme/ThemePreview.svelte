<script lang="ts">
    ...
    function handleDownload(e: MouseEvent) {
        ...
        fileService.downloadTheme(theme, `${theme.other.name || APP_NAME}.${APP_NAME.toLowerCase()}theme`)
    }
...
>
    ...
    <div
        ...
        style="background-color:{Color(theme.data.background.value).fade(0.3).toString()};z-index:2;text-shadow:{image
