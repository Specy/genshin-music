<script lang="ts">
    ...
    async function downloadSong(song: RecordedOrComposed | Midi) {
        ...
        const converted = [game.features.downloadsSongsInOldFormat ? song.toOldFormat() : song.serialize()]
            ...
            <MenuPanel id="Songs">
                ...
                <SongMenu
                    ...
                    componentProps={{
                        ...
                        functions: {removeSong: functions.removeSong, toggleMenu, downloadSong, renameSong: functions.renameSong},
                    }}
                />
                <div style="margin-top:auto;padding-top:0.5rem;width:100%;display:flex;justify-content:flex-end">
                    <AppButton
