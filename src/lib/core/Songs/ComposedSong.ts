...
// InstrumentNoteIcon used to be defined locally in this file (old SongClasses.ts imported it FROM
// here); Task 5 relocated the canonical definition into SongClasses.ts instead (needed there for
// InstrumentData/SerializedInstrumentData before this file existed) - import it from there now,
// reversing the old direction. defaultInstrumentMap below is unchanged (still exported from here).
import {ColumnNote, InstrumentData, NoteColumn, RecordedNote, type SerializedColumn, type InstrumentNoteIcon} from "./SongClasses"
